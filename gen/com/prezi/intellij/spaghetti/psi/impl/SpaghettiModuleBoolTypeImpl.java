...
public class SpaghettiModuleBoolTypeImpl extends ASTWrapperPsiElement implements SpaghettiModuleBoolType {

  public SpaghettiModuleBoolTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SpaghettiModuleVisitor) ((SpaghettiModuleVisitor)visitor).visitBoolType(this);
