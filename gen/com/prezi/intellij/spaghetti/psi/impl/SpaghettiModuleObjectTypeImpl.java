...
public class SpaghettiModuleObjectTypeImpl extends ASTWrapperPsiElement implements SpaghettiModuleObjectType {

  public SpaghettiModuleObjectTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SpaghettiModuleVisitor) ((SpaghettiModuleVisitor)visitor).visitObjectType(this);
