...
public class SpaghettiModuleComplexTypeImpl extends ASTWrapperPsiElement implements SpaghettiModuleComplexType {

  public SpaghettiModuleComplexTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SpaghettiModuleVisitor) ((SpaghettiModuleVisitor)visitor).visitComplexType(this);
